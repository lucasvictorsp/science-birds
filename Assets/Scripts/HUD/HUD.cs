...
public class HUD : ABSingleton<HUD>
{
    ...
    public static uint _totalScore_ = 0;
    ...
    private static float timeStartGameHUD;
    ...
    public double tempoAcelerado() {
        return (Time.time - timeStartGameHUD);
    }
    ...
    public void ClickDown_1() {
        ...
        Debug.Log("ABLevel.Name = " + LevelList.Instance.GetCurrentLevel().name);
        Debug.Log("Quantidade de Níveis Jogados = " + LevelList.Instance.CurrentIndex);
        Debug.Log("contInstable = " + ABSample_traj_NextLevel.contInstable);
        Debug.Log("contStable = " + ABSample_traj_NextLevel.contStable);
        Debug.Log("contNotSol = " + ABSample_traj_NextLevel.contNotSol);
        Debug.Log("contSol = " + ABSample_traj_NextLevel.contSol);
        Debug.Log("Num Iteration = " + ABSample_traj_NextLevel.iter);
    ...
    /*private void ClickUp() {
        ...
        if (_selectedBird) {
            ...
            if (!_selectedBird.IsFlying){
                Debug.Log("ClickUp-0");
                if (!_selectedBird.IsDying){
                    Debug.Log("ClickUp-1");
                    if(_selectedBird == ABGameWorld.Instance.GetCurrentBird ()) {
                        Debug.Log("ClickUp-2");
                        _selectedBird.LaunchBird ();
                    }
                }
...
/*public class HUD : ABSingleton<HUD> {
    ...
    public static uint _totalScore_;
    private uint _totalScore;
	private float _simulatedDragTimer;
